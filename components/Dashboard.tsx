    ...
    if (revenueStats.length > 0) {
      return revenueStats.map((r: any) => {
        ...
        return {
          ...
          total: r.total || 0,         // CA (Sales totalTtc)
          collected: r.collected || 0  // Encaissé réel (Payments liés aux ventes)
        };
      });
    }
    // Fallback: build from recent sales grouped by year+month
