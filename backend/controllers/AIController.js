...
export class AIController {
  ...
  static async bridgeWebhook(req, res) {
    ...
    const prodUrl     = 'https://n8n.realtechprint.com/webhook-test/booba/gestock-ia';
    const testUrl     = 'https://n8n.realtechprint.com/webhook-test/booba/gestock-ia';
  ...
  static async exportZip(req, res) {
    try {
      ...
      for (const doc of documents) {
        ...
        const safeName = (doc.filename || 'document.html').replace(/[^a-z0-9._\-]/gi, '_');
        folder.file(safeName, doc.html);
      }
